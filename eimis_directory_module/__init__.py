...
class EimisDirectory:
    """
        Module that acts as a proxy between Synapse broadcast module (and possibly frontend clients)
        and a first version of EIMIS directory made with Grist.
    """
    ...
    async def _init_directory(self):
        ...
        if response.code == 200:
            ...
            raise SynapseError(500, "Eimis error when calling user directory")
...
class EimisDirectoryServerQueryResource:
    ...
    def render(self, request: Request):
        logging.debug("EIMIS render directory module query")
...
class EimisDirectoryServerDumpResource:
    ...
    def render(self, request: Request):
        logging.debug("EIMIS render dump directory module")
